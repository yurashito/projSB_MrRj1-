...
public class AnnonceController {
    ...
    @PostMapping("/historiqueAnnonce/{idUtilisatuer}")
    public Annonce historiqueAnnonce(@PathVariable int idAnnonce){
        return this.annonceService.historiqueAnnonce(idAnnonce);
    }
