...
public class AnnonceController {
    ...
    private final AnnonceDetailRepository annonceRepository;

    @Autowired
    public AnnonceController( AnnonceService annonceService , AnnonceDetailRepository annonceDetailRepository,AnnonceDetailRepository annonceRepository ){
   ...
   @GetMapping("/recherche")
    ...
    public List<AnnonceDetailRepository> historiqueAnnonceUtilisateur(@RequestParam int idCreateur) {
