...
public class AnnonceController {
   ...
   @GetMapping("/recherche")
    ...
    public List<AnnonceDetail> historiqueAnnonceUtilisateur(int IdAnnonce,String Description,Timestamp  DateHeureAnnonce ,int IdVoiture,String Imatricule ,int  IdCouleur ,
    String  Couleur, 
    int  IdCreateur , 
    String NomCreateur ,
    int IdLieu ,
