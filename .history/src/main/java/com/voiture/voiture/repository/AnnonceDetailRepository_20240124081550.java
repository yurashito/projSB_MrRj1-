...
public class AnnonceDetailRepository {
    ...
    public AnnonceDetailRepository  historiqueAnnonceUtilisateur(int idCreateur) {
    
        @Query(value = "select * from annonce where :idCreateur = idCreateur " , nativeQuery = true)
          List<AnnonceDetailRepository> historiqueAnnonceUtilisateur(@Param("idCreateur") int idCreateur); 
